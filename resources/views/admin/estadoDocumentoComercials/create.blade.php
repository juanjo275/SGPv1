...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.estadoDocumentoComercial.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.estado-documento-comercials.store") }}" enctype="multipart/form-data">
            @csrf
